var Page = {
    ...
    WindowChanged: function () {
        ...
        var bodyW = document.documentElement.clientWidth,
            bodyH = document.documentElement.clientHeight - 50, // учитываем высоту навигационного меню
    ...
    Initialize: function () {
        if (this.IsSetup === false) {
            this.main.appendChild(Page.cvs);
            this.main.style.overflow = 'hidden';
            this.main.style.backgroundColor = 'rgb(34, 39, 56);';
